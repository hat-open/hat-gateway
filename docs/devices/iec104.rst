...
Available gateway events are:
    ...
    * ..., 'data', <data_type>, <asdu_address>, <io_address>
        ...
        Payload is specified by
        ``hat-gateway://iec104.yaml#/definitions/events/master/gateway/data/res``.
    ...
    * ..., 'command', <command_type>, <asdu_address>, <io_address>
        ...
        Payload is specified by
        ``hat-gateway://iec104.yaml#/definitions/events/master/gateway/command/res``.
    ...
    * ..., 'interrogation', <asdu_address>
        ...
        Payload is specified by
        ``hat-gateway://iec104.yaml#/definitions/events/master/gateway/interrogation/res``.
    ...
    * ..., 'counter_interrogation', <asdu_address>
        ...
        Payload is specified by
        ``hat-gateway://iec104.yaml#/definitions/events/master/gateway/counter_interrogation/res``.
...
Available system events are:
    ...
    * ..., 'command', <command_type>, <asdu_address>, <io_address>
        ...
        Payload is specified by
        ``hat-gateway://iec104.yaml#/definitions/events/master/system/command/req``.
    ...
    * ..., 'interrogation', <asdu_address>
        ...
        Payload is specified by
        ``hat-gateway://iec104.yaml#/definitions/events/master/system/interrogation/req``.
    ...
    * ..., 'counter_interrogation', <asdu_address>
        ...
        Payload is specified by
        ``hat-gateway://iec104.yaml#/definitions/events/master/system/counter_interrogation/req``.
...
is not supported (slave responds with UNKNOWN_CAUSE).
