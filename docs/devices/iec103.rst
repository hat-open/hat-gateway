...
``hat-gateway://iec103.yaml#/definitions/master``.
...
event types are used:
    ...
    * 'gateway', <gateway_name>, 'iec103_master', <device_name>, 'gateway', ...
        ...
        * ..., 'status'
            ...
            ``hat-gateway://iec103.yaml#/definitions/events/master/gateway/status``.
        ...
        * ..., 'remote_device', <device_address>, 'data', <data_type>, <asdu_address>, <io_function>, <io_information>
            ...
            Source timestamp is represents IEC103 data time.

            Payload is specified by
            ``hat-gateway://iec103.yaml#/definitions/events/master/gateway/data``.
        ...
        * ..., 'remote_device', <device_address>, 'command', <asdu_address>, <io_function>, <io_information>
            ...
            Payload is specified by
            ``hat-gateway://iec103.yaml#/definitions/events/master/gateway/command``.
    ...
    * 'gateway', <gateway_name>, 'iec103_master', <device_name>, 'system', ...
        ...
        * ..., 'remote_device', <device_address>, 'enable'
            ...
            Payload is specified by
            ``hat-gateway://iec103.yaml#/definitions/events/master/system/enable``.
        ...
        * ..., 'remote_device', <device_address>, 'command', <asdu_address>, <io_function>, <io_information>
            ...
            Payload is specified by
            ``hat-gateway://iec103.yaml#/definitions/events/master/system/command``.
